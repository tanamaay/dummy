...
const Hero = () => {
  return (
    <div className="bg-gradient z-0 ">
      ...
      <p className="text-5xl text-white text-center font-bold "> Hey, I am Deeksha!</p>
      <p className="text-white text-xl mx-auto text-center py-5 md:w-[50rem] px-5">Welcome to my corner of the internet! Crafting code and content, I&apos;m a Software developer and a article writer.Explore my portfolio for a glimpse into my dynamic skill set.</p>
